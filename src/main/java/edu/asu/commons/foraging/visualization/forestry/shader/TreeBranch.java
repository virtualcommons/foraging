...
public class TreeBranch implements Serializable {	
	...
	public int create(FloatBuffer branchVertices, FloatBuffer branchAttributes, FloatBuffer branchBaseCenters, FloatBuffer branchTransformationsRow1, FloatBuffer branchTransformationsRow2, FloatBuffer branchTransformationsRow3, FloatBuffer branchTransformationsRow4) {
		...
		if (level*2+3 <= treeAge) {
			...
			nBranchVertices += childBranch.updateGeometry(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);
			nBranchVertices += childBranch.create(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);
	...
	public int grow(FloatBuffer branchVertices, FloatBuffer branchAttributes, FloatBuffer branchBaseCenters, FloatBuffer branchTransformationsRow1, FloatBuffer branchTransformationsRow2, FloatBuffer branchTransformationsRow3, FloatBuffer branchTransformationsRow4) {
		...
		if (nChildren != 0){
			for (int childIndex = 0; childIndex < nChildren; childIndex++) {
				...
				nBranchVertices += childBranch.updateParamValues(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);
				nBranchVertices += childBranch.grow(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);
			}
		}
		else {
	...
	public int updateParamValues(FloatBuffer branchVertices, FloatBuffer branchAttributes, FloatBuffer branchBaseCenters, FloatBuffer branchTransformationsRow1, FloatBuffer branchTransformationsRow2, FloatBuffer branchTransformationsRow3, FloatBuffer branchTransformationsRow4) {
		...
		//bounding box
		return updateGeometry(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);	
	}
	
	
	//###################### Bounding box related functions ###################
	public int updateGeometry(FloatBuffer branchVertices, FloatBuffer branchAttributes, FloatBuffer branchBaseCenters, FloatBuffer branchTransformationsRow1, FloatBuffer branchTransformationsRow2, FloatBuffer branchTransformationsRow3, FloatBuffer branchTransformationsRow4) {
...
//		addBranchVertex(branchVertices, boundingBox_ws.getTRF());
		...
		boundingBox_ws.populateVBOWithVertices(branchVertices);
