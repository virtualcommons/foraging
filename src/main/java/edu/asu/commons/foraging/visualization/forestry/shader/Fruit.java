...
public class Fruit {
	...
	public int createVBO(FloatBuffer vertexBuffer, FloatBuffer attributeBuffer, FloatBuffer baseCenterBuffer, FloatBuffer transformationRow1Buffer, FloatBuffer transformationRow2Buffer, FloatBuffer transformationRow3Buffer, FloatBuffer transformationRow4Buffer) {
		
		int nVertices = boundingBox_ws.populateVBOWithVertices(vertexBuffer);
	...
	public int updateVBO(FloatBuffer vertexBuffer, FloatBuffer attributeBuffer, FloatBuffer baseCenterBuffer, FloatBuffer transformationRow4Buffer) {		
		int nVertices = boundingBox_ws.populateVBOWithVertices(vertexBuffer); 
		for (int vertexIndex = 0; vertexIndex < nVertices; vertexIndex++) {
			addAttributes2VBO(attributeBuffer);
			addBaseCenter2VBO(baseCenterBuffer);
