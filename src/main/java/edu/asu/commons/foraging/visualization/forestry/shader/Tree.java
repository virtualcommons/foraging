...
//	public static transient float[] branchSpecular = {0.5f, 0.5f, 0.5f, 1.0f};
	...
	public int create(FloatBuffer branchVertices, FloatBuffer branchAttributes, FloatBuffer branchBaseCenters, FloatBuffer branchTransformationsRow1, FloatBuffer branchTransformationsRow2, FloatBuffer branchTransformationsRow3, FloatBuffer branchTransformationsRow4) {
		int nVertices = trunk.updateGeometry(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);
		nVertices += trunk.create(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);
	...
	public int grow(FloatBuffer branchVertices, FloatBuffer branchAttributes, FloatBuffer branchBaseCenters, FloatBuffer branchTransformationsRow1, FloatBuffer branchTransformationsRow2, FloatBuffer branchTransformationsRow3, FloatBuffer branchTransformationsRow4) {
		//Remove leaves that are present as we update branch parameters and/or add new branches 
		removeLeaves();
		
		int nVertices = trunk.updateParamValues(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);
		nVertices += trunk.grow(branchVertices, branchAttributes, branchBaseCenters, branchTransformationsRow1, branchTransformationsRow2, branchTransformationsRow3, branchTransformationsRow4);
...
//			gl.glMaterialf(GL.GL_FRONT_AND_BACK, GL.GL_SHININESS, Tree.shininess);
	...
	public int createHeapBoundingBox(FloatBuffer vertices, FloatBuffer vertexAttributes, FloatBuffer baseCenters, FloatBuffer transformationsRow1, FloatBuffer transformationsRow2, FloatBuffer transformationsRow3, FloatBuffer transformationsRow4) {
...
//		System.out.println("Total # leaf clusters = " + nLeafVertices);
	...
	public int createFruitVBO(FloatBuffer vertexBuffer, FloatBuffer attributeBuffer, FloatBuffer baseCenterBuffer, FloatBuffer transformationRow1Buffer, FloatBuffer transformationRow2Buffer, FloatBuffer transformationRow3Buffer, FloatBuffer transformationRow4Buffer) {
		
		int nVertices = 0;
		for (int fruitIndex = 0; fruitIndex < fruits.size(); fruitIndex++) {
			Fruit fruit = fruits.get(fruitIndex);
			nVertices += fruit.createVBO(vertexBuffer, attributeBuffer, baseCenterBuffer, transformationRow1Buffer, transformationRow2Buffer, transformationRow3Buffer, transformationRow4Buffer);
		}
	...
	public int updateFruitVBO(FloatBuffer vertexBuffer, FloatBuffer attributesBuffer, FloatBuffer baseCenterBuffer, FloatBuffer transformationRow4Buffer) {
		int nVertices = 0;
		for (int fruitIndex = 0; fruitIndex < fruits.size(); fruitIndex++) {
			Fruit fruit = fruits.get(fruitIndex);
			nVertices += fruit.updateVBO(vertexBuffer, attributesBuffer, baseCenterBuffer, transformationRow4Buffer);
		}
