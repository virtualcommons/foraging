 ...
 *
 * FIXME: data files generated by this generator should be refactored to follow tidy data principles.
 *
 * For example header should be something like:
 *
 * ID, Period, Moves, Tokens Collected, Average Token Probability, Group distances
 * 
...
public class AggregateTimeIntervalProcessor extends SaveFileProcessor.Base {
    ...
    public void process(SavedRoundData savedRoundData, PrintWriter writer) {
        ...
        for (Identifier id: orderedIdentifiers) {
            movementHeader.add(id.getUUID() + " moves");
            collectedTokensHeader.add(id.getUUID() + " tokens collected");
        }
        ...
        for (GroupDataModel group: groups) {
            ...
            for (int i = 0; i < ids.size();  i++) {
                ...
                for (int j = i+1; j < ids.size(); j++) {
                    ...
                    distanceHeader.add(String.format("%s (%s -> %s)", groupNumber, id.getUUID(), secondId.getUUID()));
                }
            }
        }
