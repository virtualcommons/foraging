 ...
 * @author alllee
 */
public class TrustGameWindow extends JPanel {
    ...
    public TrustGameWindow(ForagingClient client) {
        this();
        this.client = client;
